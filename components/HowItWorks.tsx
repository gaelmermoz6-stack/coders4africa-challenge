...
export default function HowItWorks() {
  return (
    <section className="section-shell py-24 sm:py-28">
      ...
      >
        <p className="text-xs font-semibold uppercase tracking-[0.35em] text-cyan-300/80">Inclus dans le challenge</p>
        <h2 className="mt-4 font-display text-3xl font-bold text-white sm:text-5xl">Tout ce qu&apos;il vous faut pour commencer</h2>
      </motion.div>
